...
public class Server extends UnicastRemoteObject implements checkBal {
    ...
    static ArrayList<Account> a = new ArrayList<Account>() {
        {
            add(new Account("111111", "Shubham1", 2000.0));
            add(new Account("222222", "Shubham2", 3000.0));
            add(new Account("333333", "Shubham3", 4000.0));
            add(new Account("444444", "Shubham4", 5000.0));
        }
    };
    int RN[];
    boolean critical;
